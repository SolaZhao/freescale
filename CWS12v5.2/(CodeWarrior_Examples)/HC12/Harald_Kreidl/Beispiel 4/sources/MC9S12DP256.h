/*****************************************************
    MC9S12DP256.h - Target interface library
...
/*                                         DEFINE PORT A                                          */
/**************************************************************************************************/
 volatile  unsigned char  PORTA   _IO_AT(0x00);  /* port A */

 volatile  unsigned char  DDRA     _IO_AT(0x02);  /* data direction port A */

/**************************************************************************************************/
/*                                         DEFINE PORT B                                          */
/**************************************************************************************************/
 volatile  unsigned char PORTB    _IO_AT(0x01);  /* port B */

 volatile  unsigned char DDRB     _IO_AT(0x03);  /* data direction port B */

/**************************************************************************************************/
/*                                         DEFINE PORT E                                          */
/**************************************************************************************************/

 volatile  unsigned char PORTE    _IO_AT(0x08);  /* port E */
...
/**************************************************************************************************/
 volatile  unsigned char  MTST0   _IO_AT(0x14); 
 volatile  unsigned char  MTST1   _IO_AT(0x17); 
...
/**************************************************************************************************/
 volatile  union {                  
  struct {          
    unsigned char _ADR:4;
    unsigned char _WRTINT:1;
    unsigned char BIT5:1;
    unsigned char BIT6:1;
    unsigned char BIT7:1;
  } ITCR_BITS;        
...
/*DEFINE REGISTER BITS*/
#define ADR ITCR1.ITCR_BITS._ADR
#define WRTINT ITCR1.ITCR_BITS._WRTINT
...
/*******************************************************************************************/
 volatile  unsigned char BKP0X    _IO_AT(0x2A);  /* Breakpoint Address Register,Bank Number*/
 volatile  unsigned int  BKP0     _IO_AT(0x2B);  /* Breakpoint Address Register*/

 volatile  unsigned char BKP1X    _IO_AT(0x2D);  /* Breakpoint Address Register,Bank Number*/
 volatile  unsigned int  BKP1     _IO_AT(0x2E);  /* Breakpoint Data Register*/

/*******************************************************************************************/
/*                             (PROGRAM) PAGE INDEX REGISTER                               */                                
/*******************************************************************************************/
 volatile  unsigned char PPAGE    _IO_AT(0x30);  

/*******************************************************************************************/
/*                                              PORT K                                     */                                
/*******************************************************************************************/
 volatile  unsigned char PORTK    _IO_AT(0x32);  /* port K */

 volatile  unsigned char DDRK     _IO_AT(0x33);  /* data direction port K */

/*******************************************************************************************/
/*                                    SYNTHETIZER REGISTER                                 */
/*******************************************************************************************/
/* Bits 6-7 is this registers are unimplemented. They cannot be used. */
 volatile  unsigned char SYNR _IO_AT(0x34);

/*******************************************************************************************/
/*                              REFERENCE DIVIDER REGISTER                                 */
/*******************************************************************************************/
/* Bits 4-7 is this registers are unimplemented. They cannot be used. */
 volatile  unsigned char REFDV _IO_AT(0x35);

/**************************************************************************************************/
/*                                     CLOCK GENERATOR TEST REGISTER                              */
/**************************************************************************************************/
 volatile  unsigned char  CTFLG    _IO_AT(0x36);  
...
/*                                                                            */
/**************************************************************************************************/
 volatile  unsigned char CTCTL     _IO_AT(0x3E);  
 volatile  unsigned char ARMCOP    _IO_AT(0x3F);  

/*******************************************************************************************/
/*                           TIMER INPUT/OUTPUT COMPARE SELECT                             */
/*******************************************************************************************/   
 volatile  unsigned char TIOS     _IO_AT(0x40);

/*******************************************************************************************/
/*                          TIMER COMPARE FORCE REGISTER                                  */
/*******************************************************************************************/
 volatile  unsigned char TCFORC    _IO_AT(0x41); 

/*******************************************************************************************/
/*                         OUTPUT COMPARE 7 MASK REGISTER                                  */
/*******************************************************************************************/
 volatile  unsigned char TOC7M     _IO_AT(0x42); 

/*******************************************************************************************/
/*                         OUTPUT COMPARE 7 DATA REGISTER                                  */
/*******************************************************************************************/
 volatile  unsigned char TOC7D     _IO_AT(0x43);

/*******************************************************************************************/
/*                         OUTPUT COMPARE 7 DATA REGISTER                                  */
/*******************************************************************************************/
 volatile  unsigned int TCNT     _IO_AT(0x44); 
...
/*                                                  */
/*******************************************************************************************/
 volatile  unsigned char TTOV     _IO_AT(0x47);  
...
/*DEFINE REGISTER*/                          
#define TIE TIE1.TIE_BYTE            

/*DEFINE REGISTER BITS*/                     
#define C0I TIE1.TIE_BITS._C0I       
#define C1I TIE1.TIE_BITS._C1I     
#define C2I TIE1.TIE_BITS._C2I       
#define C3I TIE1.TIE_BITS._C3I       
#define C4I TIE1.TIE_BITS._C4I       
#define C5I TIE1.TIE_BITS._C5I    
#define C6I TIE1.TIE_BITS._C6I       
#define C7I TIE1.TIE_BITS._C7I           
...
/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 0*****/
 volatile  unsigned int TC0      _IO_AT(0x50);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 1*****/
 volatile  unsigned int TC1      _IO_AT(0x52);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 2*****/
 volatile  unsigned int TC2      _IO_AT(0x54);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 3*****/
 volatile  unsigned int TC3      _IO_AT(0x56);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 4*****/
 volatile  unsigned int TC4      _IO_AT(0x58);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 5*****/
 volatile  unsigned int TC5      _IO_AT(0x5a);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 6*****/
 volatile  unsigned int TC6      _IO_AT(0x5c);  

/*****TIMER INPUT CAPTURE/OUTPUT REGISTER 7*****/
 volatile  unsigned int TC7      _IO_AT(0x5e);  
...
/*******************************************************************************************/
 volatile  unsigned char PACN3    _IO_AT(0x62);  
 volatile  unsigned char PACN2    _IO_AT(0x63);  
 volatile  unsigned char PACN1    _IO_AT(0x64);  
 volatile  unsigned char PACN0    _IO_AT(0x65);  
...
/*******************************************************************************************/
 volatile  unsigned char ICOVW    _IO_AT(0x6A);  
...
/*******************************************************************************************/
 volatile  unsigned char PA3H    _IO_AT(0x72);  
 volatile  unsigned char PA2H    _IO_AT(0x73); 
 volatile  unsigned char PA1H    _IO_AT(0x74); 
 volatile  unsigned char PA0H    _IO_AT(0x75); 

/*******************************************************************************************/  
/*                              MODULUS DOWN-COUNTER REGISTERS                             */  
/*******************************************************************************************/  
 volatile  unsigned char MCCNTH   _IO_AT(0x76);    /* Modulus down-counter high */                                     
 volatile  unsigned char MCCNTL   _IO_AT(0x77);    /* Modulus down-counter high */ 

/*******************************************************************************************/  
/*                         TIMER INPUT CAPTURE HOLDING REGISTERS                           */  
/*******************************************************************************************/  
 volatile  unsigned int TC0H   _IO_AT(0x78); /* Timer Input Capture Holding Register 0 */ 
 volatile  unsigned int TC1H   _IO_AT(0x7A); /* Timer Input Capture Holding Register 1 */ 
 volatile  unsigned int TC2H   _IO_AT(0x7C); /* Timer Input Capture Holding Register 2 */ 
 volatile  unsigned int TC3H   _IO_AT(0x7E); /* Timer Input Capture Holding Register 3 */
...
typedef  union {                         
  struct {                          
    ...
    unsigned int  _CC2:1;           
    unsigned int  BIT3:1;           
    unsigned int  _FIFOR:1;
    unsigned int  _ETORF:1;
    unsigned int  BIT6:1;
    unsigned int  _SCF:1;
...
/**************************************************************************************************/
 volatile  unsigned char ATD0CTL0  _IO_AT(0x80); /* A/D control register 0 */
 volatile  unsigned char ATD0CTL1  _IO_AT(0x81); /* A/D control register 1 */
...
/**********ATD CONTROL REGISTER 2********/
 volatile  ATDCTL2_TYPE ATD0CTL21 _IO_AT(0x82);                
...
/**********ATD CONTROL REGISTER 3********/
 volatile  ATDCTL3_TYPE ATD0CTL31 _IO_AT(0x83);            
...
/**********ATD CONTROL REGISTER 4********/
 volatile  ATDCTL4_TYPE ATD0CTL41 _IO_AT(0x84);            
...
/**********ATD CONTROL REGISTER 5********/
 volatile  ATDCTL5_TYPE ATD0CTL51 _IO_AT(0x85);            
...
/**************************************************************************************************/
/*                                   ATD 0 STATUS REGISTER                                        */
/**************************************************************************************************/
 volatile  ATDSTAT_TYPE ATD0STAT1 _IO_AT(0x86);            

/*DEFINE REGISTER*/                       
#define ATD0STAT ATD0STAT1.ATDSTAT_WORD      

/*DEFINE REGISTER BITS*/                  
#define CC0_0   ATD0STAT1.ATDSTAT_BITS._CC0  
#define CC1_0   ATD0STAT1.ATDSTAT_BITS._CC1
#define CC2_0   ATD0STAT1.ATDSTAT_BITS._CC2
#define FIFOR_0 ATD0STAT1.ATDSTAT_BITS._FIFOR
#define ETORF_0 ATD0STAT1.ATDSTAT_BITS._ETORF
#define SCF_0   ATD0STAT1.ATDSTAT_BITS._SCF
#define CCF0_0  ATD0STAT1.ATDSTAT_BITS._CCF0
#define CCF1_0  ATD0STAT1.ATDSTAT_BITS._CCF1 
#define CCF2_0  ATD0STAT1.ATDSTAT_BITS._CCF2 
#define CCF3_0  ATD0STAT1.ATDSTAT_BITS._CCF3 
#define CCF4_0  ATD0STAT1.ATDSTAT_BITS._CCF4 
#define CCF5_0  ATD0STAT1.ATDSTAT_BITS._CCF5 
#define CCF6_0  ATD0STAT1.ATDSTAT_BITS._CCF6 
#define CCF7_0  ATD0STAT1.ATDSTAT_BITS._CCF7 
...
/********ATD TEST REGISTER HIGH*********/
 volatile  ATDTEST0_TYPE ATD0TEST01 _IO_AT(0x88);                
...
/********ATD TEST REGISTER LOW**********/
 volatile  ATDTEST1_TYPE ATD0TEST11 _IO_AT(0x89);                
...
#define SAR1_0 ATD0TEST11.ATDTEST1_BITS._SAR1       
 ...
 volatile  unsigned char ATD0DIEN  _IO_AT(0x8D); 
 volatile  unsigned char PORTAD0   _IO_AT(0x8F); 
 volatile  unsigned int  ATD0DR0   _IO_AT(0x90); 
 volatile  unsigned int  ATD0DR1   _IO_AT(0x92); 
 volatile  unsigned int  ATD0DR2   _IO_AT(0x94); 
 volatile  unsigned int  ATD0DR3   _IO_AT(0x96); 
 volatile  unsigned int  ATD0DR4   _IO_AT(0x98); 
 volatile  unsigned int  ATD0DR5   _IO_AT(0x9A); 
 volatile  unsigned int  ATD0DR6   _IO_AT(0x9C); 
 volatile  unsigned int  ATD0DR7   _IO_AT(0x9E); 

/**************************************************************************************************/
/*                                  ATD 1 RESERVED REGISTERS                                      */
/**************************************************************************************************/
 volatile  unsigned char ATD1CTL0  _IO_AT(0x120); /* A/D control register 0 */
 volatile  unsigned char ATD1CTL1  _IO_AT(0x121); /* A/D control register 1 */
...
/**********ATD CONTROL REGISTER 2********/
 volatile  ATDCTL2_TYPE ATD1CTL21 _IO_AT(0x122);                
...
/**********ATD CONTROL REGISTER 3********/
 volatile  ATDCTL3_TYPE ATD1CTL31 _IO_AT(0x123);            
...
/**********ATD CONTROL REGISTER 4********/
 volatile  ATDCTL4_TYPE ATD1CTL41 _IO_AT(0x124);            
...
/**********ATD CONTROL REGISTER 5********/
 volatile  ATDCTL5_TYPE ATD1CTL51 _IO_AT(0x125);            
...
/**************************************************************************************************/
/*                                   ATD 1 STATUS REGISTER                                        */
/**************************************************************************************************/
 volatile  ATDSTAT_TYPE ATD1STAT1 _IO_AT(0x126);            

/*DEFINE REGISTER*/                       
#define ATD1STAT ATD1STAT1.ATDSTAT_WORD      

/*DEFINE REGISTER BITS*/                  
#define CC0_1   ATD1STAT1.ATDSTAT_BITS._CC0  
#define CC1_1   ATD1STAT1.ATDSTAT_BITS._CC1
#define CC2_1   ATD1STAT1.ATDSTAT_BITS._CC2
#define FIFOR_1 ATD1STAT1.ATDSTAT_BITS._FIFOR
#define ETORF_1 ATD1STAT1.ATDSTAT_BITS._ETORF
#define SCF_1   ATD1STAT1.ATDSTAT_BITS._SCF
#define CCF0_1  ATD1STAT1.ATDSTAT_BITS._CCF0
#define CCF1_1  ATD1STAT1.ATDSTAT_BITS._CCF1 
#define CCF2_1  ATD1STAT1.ATDSTAT_BITS._CCF2 
#define CCF3_1  ATD1STAT1.ATDSTAT_BITS._CCF3 
#define CCF4_1  ATD1STAT1.ATDSTAT_BITS._CCF4 
#define CCF5_1  ATD1STAT1.ATDSTAT_BITS._CCF5 
#define CCF6_1  ATD1STAT1.ATDSTAT_BITS._CCF6 
#define CCF7_1  ATD1STAT1.ATDSTAT_BITS._CCF7 
...
/********ATD TEST REGISTER HIGH*********/
 volatile  ATDTEST0_TYPE ATD1TEST01 _IO_AT(0x128);                
...
/********ATD TEST REGISTER LOW**********/
 volatile  ATDTEST1_TYPE ATD1TEST11 _IO_AT(0x129);                
...
#define SAR1_1 ATD1TEST11.ATDTEST1_BITS._SAR1       
 ...
 volatile  unsigned char ATD1DIEN  _IO_AT(0x12D); 
 volatile  unsigned char PORTAD1   _IO_AT(0x12F); 
 volatile  unsigned int  ATD1DR0   _IO_AT(0x130); 
 volatile  unsigned int  ATD1DR1   _IO_AT(0x132); 
 volatile  unsigned int  ATD1DR2   _IO_AT(0x134); 
 volatile  unsigned int  ATD1DR3   _IO_AT(0x136); 
 volatile  unsigned int  ATD1DR4   _IO_AT(0x138); 
 volatile  unsigned int  ATD1DR5   _IO_AT(0x13A); 
 volatile  unsigned int  ATD1DR6   _IO_AT(0x13C); 
 volatile  unsigned int  ATD1DR7   _IO_AT(0x13E); 
...
/*******************************************************************************************/
 volatile  unsigned char PWMTST   _IO_AT(0xA6);  /* PWM Test Register */

/*******************************************************************************************/
/*                                 PWM PRESCALE COUNTER                                    */
/*******************************************************************************************/
 volatile  unsigned char PWMPRSC   _IO_AT(0xA7);  /* PWM Prescale Counter */

/*******************************************************************************************/
/*                                 PWM SCALE REGISTER A                                    */
/*******************************************************************************************/
 volatile  unsigned char PWMSCALA  _IO_AT(0xA8); /* PWM Scale A */

/*******************************************************************************************/
/*                                 PWM SCALE REGISTER B                                    */
/*******************************************************************************************/
 volatile  unsigned char PWMSCALB  _IO_AT(0xA9); /* PWM Scale B */

/*******************************************************************************************/
/*                                 PWM SCALE COUNTER VALUE A                               */
/*******************************************************************************************/
 volatile  unsigned char PWMSCNTA  _IO_AT(0xAA); /* PWM Counter A */

/*******************************************************************************************/
/*                                 PWM SCALE COUNTER VALUE B                               */
/*******************************************************************************************/
 volatile  unsigned char PWMSCNTB  _IO_AT(0xAB); /* PWM Counter B */

/*******************************************************************************************/
/*                                      PWM CHANNEL COUNTERS                               */
/*******************************************************************************************/
 volatile  unsigned char PWMCNT0   _IO_AT(0xAC);  /* PWM Channel Counter 0 */
 volatile  unsigned char PWMCNT1   _IO_AT(0xAD);  /* PWM Channel Counter 1 */
 volatile  unsigned char PWMCNT2   _IO_AT(0xAE);  /* PWM Channel Counter 2 */
 volatile  unsigned char PWMCNT3   _IO_AT(0xAF);  /* PWM Channel Counter 3 */
 volatile  unsigned char PWMCNT4   _IO_AT(0xB0);  /* PWM Channel Counter 4 */
 volatile  unsigned char PWMCNT5   _IO_AT(0xB1);  /* PWM Channel Counter 5 */
 volatile  unsigned char PWMCNT6   _IO_AT(0xB2);  /* PWM Channel Counter 6 */
 volatile  unsigned char PWMCNT7   _IO_AT(0xB3);  /* PWM Channel Counter 7 */

/*******************************************************************************************/
/*                              PWM CHANNEL PERIOD REGISTERS                               */
/*******************************************************************************************/
 volatile  unsigned char PWMPER0   _IO_AT(0xB4);  /* PWM Channel Period 0 */
 volatile  unsigned char PWMPER1   _IO_AT(0xB5);  /* PWM Channel Period 1 */
 volatile  unsigned char PWMPER2   _IO_AT(0xB6);  /* PWM Channel Period 2 */
 volatile  unsigned char PWMPER3   _IO_AT(0xB7);  /* PWM Channel Period 3 */
 volatile  unsigned char PWMPER4   _IO_AT(0xB8);  /* PWM Channel Period 4 */
 volatile  unsigned char PWMPER5   _IO_AT(0xB9);  /* PWM Channel Period 5 */
 volatile  unsigned char PWMPER6   _IO_AT(0xBA);  /* PWM Channel Period 6 */
 volatile  unsigned char PWMPER7   _IO_AT(0xBB);  /* PWM Channel Period 7 */

/*******************************************************************************************/
/*                                PWM CHANNEL DUTY REGISTERS                               */
/*******************************************************************************************/
 volatile  unsigned char PWMDTY0   _IO_AT(0xBC);  /* PWM Channel Duty 0 */
 volatile  unsigned char PWMDTY1   _IO_AT(0xBD);  /* PWM Channel Duty 1 */
 volatile  unsigned char PWMDTY2   _IO_AT(0xBE);  /* PWM Channel Duty 2 */
 volatile  unsigned char PWMDTY3   _IO_AT(0xBF);  /* PWM Channel Duty 3 */
 volatile  unsigned char PWMDTY4   _IO_AT(0xC0);  /* PWM Channel Duty 4 */
 volatile  unsigned char PWMDTY5   _IO_AT(0xC1);  /* PWM Channel Duty 5 */
 volatile  unsigned char PWMDTY6   _IO_AT(0xC2);  /* PWM Channel Duty 6 */
 volatile  unsigned char PWMDTY7   _IO_AT(0xC3);  /* PWM Channel Duty 7 */
...
#define PWN7IN   PWMSDN1.PWMSDN_BITS._PWN7IN       
...
/*****SCI BAUD RATE CONTROL REGISTER 0 HIGH*****/
 volatile  SCIBDH_TYPE SCI0BDH1 _IO_AT(0xC8);                
...
/*****SCI BAUD RATE CONTROL REGISTER 0 LOW*****/
 volatile  SCIBDL_TYPE SCI0BDL1 _IO_AT(0xC9);                
...
/*****SCI 0 CONTROL REGISTER 1*****/
 volatile  SCICR1_TYPE SCI0CR11 _IO_AT(0xCA);                
...
/*****SCI 0 CONTROL REGISTER 2*****/
 volatile  SCICR2_TYPE SCI0CR21 _IO_AT(0xCB);                
...
/*****SCI 0 STATUS REGISTER 1*****/
 volatile  SCISR1_TYPE SCI0SR11 _IO_AT(0xCC);                
...
/*****SCI 0 STATUS REGISTER 2*****/
 volatile  SCISR2_TYPE SCI0SR21 _IO_AT(0xCD);                
...
/*****SCI DATA REGISTER 0 HIGH*****/
 volatile  SCIDRH_TYPE SCI0DRH1 _IO_AT(0xCE);                
...
/*****SCI DATA REGISTER 0 LOW*****/
 volatile  unsigned char SCI0DRL    _IO_AT(0xCF);  
...
/*****SCI BAUD RATE CONTROL REGISTER 1 HIGH*****/
 volatile  SCIBDH_TYPE SCI1BDH1 _IO_AT(0xD0);                
...
/*****SCI BAUD RATE CONTROL REGISTER 1 LOW*****/
 volatile  SCIBDL_TYPE SCI1BDL1 _IO_AT(0xD1);                
...
/*****SCI 1 CONTROL REGISTER 1*****/
 volatile  SCICR1_TYPE SCI1CR11 _IO_AT(0xD2);                
...
/*****SCI 1 CONTROL REGISTER 2*****/
 volatile  SCICR2_TYPE SCI1CR21 _IO_AT(0xD3);                
...
/*****SCI 1 STATUS REGISTER 1*****/
 volatile  SCISR1_TYPE SCI1SR11 _IO_AT(0xD4);                
...
/*****SCI 1 STATUS REGISTER 2*****/
 volatile  SCISR2_TYPE SCI1SR21 _IO_AT(0xD5);                
...
/*****SCI DATA REGISTER 1 HIGH*****/
 volatile  SCIDRH_TYPE SCI1DRH1 _IO_AT(0xD6);                
...
/*****SCI DATA REGISTER 1 LOW*****/
 volatile  unsigned char SCI1DRL    _IO_AT(0xD7);  
...
/*****SPI CONTROL REGISTER 1*****/
 volatile  SPICR1_TYPE SPI0CR11 _IO_AT(0xD8);                
...
/*****SPI 0 CONTROL REGISTER 2*****/
 volatile  SPICR2_TYPE SPI0CR21 _IO_AT(0xD9);                
...
/*******************************************************************************************/
 volatile  SPIBR_TYPE SPI0BR1 _IO_AT(0xDA);                
...
/*******************************************************************************************/
 volatile  SPISR_TYPE SPI0SR1 _IO_AT(0xDB);                
...
/*******************************************************************************************/
 volatile  unsigned char SPI0DR    _IO_AT(0xDD);  
...
/*****SPI CONTROL REGISTER 1*****/
 volatile  SPICR1_TYPE SPI1CR11 _IO_AT(0xF0);                
...
/*****SPI 1 CONTROL REGISTER 2*****/
 volatile  SPICR2_TYPE SPI1CR21 _IO_AT(0xF1);                
...
/*******************************************************************************************/
 volatile  SPIBR_TYPE SPI1BR1 _IO_AT(0xF2);                
...
/*******************************************************************************************/
 volatile  SPISR_TYPE SPI1SR1 _IO_AT(0xF3);                
...
/*******************************************************************************************/
 volatile  unsigned char SPI1DR    _IO_AT(0xF5);  
...
/*****SPI CONTROL REGISTER 1*****/
 volatile  SPICR1_TYPE SPI2CR11 _IO_AT(0xF8);                
...
/*****SPI 2 CONTROL REGISTER 2*****/
 volatile  SPICR2_TYPE SPI2CR21 _IO_AT(0xF9);                
...
/*******************************************************************************************/
 volatile  SPIBR_TYPE SPI2BR1 _IO_AT(0xFA);                
...
/*******************************************************************************************/
 volatile  SPISR_TYPE SPI2SR1 _IO_AT(0xFB);                
...
/*******************************************************************************************/
 volatile  unsigned char SPI2DR    _IO_AT(0xFD);  

/*******************************************************************************************/
/*                                    IIC BUS ADDRESS REGISTER                             */
/*******************************************************************************************/
 volatile  unsigned char IBAD    _IO_AT(0xE0);  
...
/**************************************************************************************************/    
 volatile  unsigned char  IICDR    _IO_AT(0xE4);                                             
...
/*                                                                     */
/*******************************************************************************************/
 volatile  unsigned char DLCBDR    _IO_AT(0xEB);  
...
/*DEFINE REGISTER BITS*/                     
#define IDLE_Condition DLCBSTAT1.DLCBSTAT_BITS._IDLE     
...
/*                             MSCAN12 MODULE CONTROL REGISTER 0                           */                                
/*******************************************************************************************/
 volatile  CANCTL0_TYPE CAN0CTL01 _IO_AT(0x140);               
...
/*                             MSCAN12 MODULE CONTROL REGISTER 1                           */
/*******************************************************************************************/
 volatile  CANCTL1_TYPE CAN0CTL11 _IO_AT(0x141);               
...
/*                               MSCAN12 BUS TIMING REGISTER 0                             */
/*******************************************************************************************/
 volatile  CANBTR0_TYPE CAN0BTR01 _IO_AT(0x142);               
...
/*                               MSCAN12 BUS TIMING REGISTER 1                             */
/*******************************************************************************************/
 volatile  CANBTR1_TYPE CAN0BTR11 _IO_AT(0x143);               
...
/*                               MSCAN12 RECEIVER FLAG REGISTER                            */
/*******************************************************************************************/
 volatile  CANRFLG_TYPE CAN0RFLG1 _IO_AT(0x144);               
...
/*                      MSCAN12 RECEIVER INTERRUPT ENABLE REGISTER                         */
/*******************************************************************************************/
 volatile  CANRIER_TYPE CAN0RIER1 _IO_AT(0x145);               
...
/*                          MSCAN12 TRANSMITTER FLAG REGISTER                              */
/*******************************************************************************************/
 volatile  CANTFLG_TYPE CAN0TFLG1 _IO_AT(0x146);               
...
/*                          MSCAN12 TRANSMITTER CONTROL REGISTER                           */
/*******************************************************************************************/
 volatile  CANTIER_TYPE CAN0TIER1 _IO_AT(0x147);               
...
/*                          MSCAN12 IDENTIFIER ACCEPTANCE CONTROL REGISTER                 */
/*******************************************************************************************/
 volatile  CANTARQ_TYPE CAN0TARQ1 _IO_AT(0x148);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTAAK_TYPE CAN0TAAK1 _IO_AT(0x149);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTBSEL_TYPE CAN0TBSEL1 _IO_AT(0x14A);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANIDAC_TYPE CAN0IDAC1 _IO_AT(0x14B);               
...
/**************************************************************************************************/
 volatile  unsigned char  CAN0RXERR    _IO_AT(0x14E); 

/**************************************************************************************************/
/*                                     MSCAN12 TRANSMIT ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN0TXERR    _IO_AT(0x14F); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN0IDAR0    _IO_AT(0x150); 
 volatile  unsigned char  CAN0IDAR1    _IO_AT(0x151); 
 volatile  unsigned char  CAN0IDAR2    _IO_AT(0x152); 
 volatile  unsigned char  CAN0IDAR3    _IO_AT(0x153); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN0IDMR0    _IO_AT(0x154); 
 volatile  unsigned char  CAN0IDMR1    _IO_AT(0x155); 
 volatile  unsigned char  CAN0IDMR2    _IO_AT(0x156); 
 volatile  unsigned char  CAN0IDMR3    _IO_AT(0x157); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN0IDAR4    _IO_AT(0x158); 
 volatile  unsigned char  CAN0IDAR5    _IO_AT(0x159); 
 volatile  unsigned char  CAN0IDAR6    _IO_AT(0x15A); 
 volatile  unsigned char  CAN0IDAR7    _IO_AT(0x15B); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN0IDMR4    _IO_AT(0x15C); 
 volatile  unsigned char  CAN0IDMR5    _IO_AT(0x15D); 
 volatile  unsigned char  CAN0IDMR6    _IO_AT(0x15E); 
 volatile  unsigned char  CAN0IDMR7    _IO_AT(0x15F); 

/**************************************************************************************************/
/*                                  FOREGROUND RECEIVE BUFFER                                     */
/**************************************************************************************************/
 volatile  unsigned char  CAN0RXFG[16]    _IO_AT(0x160); 

/**************************************************************************************************/
/*                                  FOREGROUND TRANSMIT BUFFER                                    */
/**************************************************************************************************/
 volatile  unsigned char  CAN0TXFG[16]    _IO_AT(0x170); 

/*******************************************************************************************/
/*                             MSCAN12 MODULE CONTROL REGISTER 0                           */                                
/*******************************************************************************************/
 volatile  CANCTL0_TYPE CAN1CTL01 _IO_AT(0x180);               
...
/*                             MSCAN12 MODULE CONTROL REGISTER 1                           */
/*******************************************************************************************/
 volatile  CANCTL1_TYPE CAN1CTL11 _IO_AT(0x181);               
...
/*                               MSCAN12 BUS TIMING REGISTER 0                             */
/*******************************************************************************************/
 volatile  CANBTR0_TYPE CAN1BTR01 _IO_AT(0x182);               
...
/*                               MSCAN12 BUS TIMING REGISTER 1                             */
/*******************************************************************************************/
 volatile  CANBTR1_TYPE CAN1BTR11 _IO_AT(0x183);               
...
/*                               MSCAN12 RECEIVER FLAG REGISTER                            */
/*******************************************************************************************/
 volatile  CANRFLG_TYPE CAN1RFLG1 _IO_AT(0x184);               
...
/*                      MSCAN12 RECEIVER INTERRUPT ENABLE REGISTER                         */
/*******************************************************************************************/
 volatile  CANRIER_TYPE CAN1RIER1 _IO_AT(0x185);               
...
/*                          MSCAN12 TRANSMITTER FLAG REGISTER                              */
/*******************************************************************************************/
 volatile  CANTFLG_TYPE CAN1TFLG1 _IO_AT(0x186);               
...
/*                          MSCAN12 TRANSMITTER CONTROL REGISTER                           */
/*******************************************************************************************/
 volatile  CANTIER_TYPE CAN1TIER1 _IO_AT(0x187);               
...
/*                          MSCAN12 IDENTIFIER ACCEPTANCE CONTROL REGISTER                 */
/*******************************************************************************************/
 volatile  CANTARQ_TYPE CAN1TARQ1 _IO_AT(0x188);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTAAK_TYPE CAN1TAAK1 _IO_AT(0x189);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTBSEL_TYPE CAN1TBSEL1 _IO_AT(0x18A);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANIDAC_TYPE CAN1IDAC1 _IO_AT(0x18B);               
...
/*                                      MSCAN12 RECEIVE ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN1RXERR    _IO_AT(0x18E); 

/**************************************************************************************************/
/*                                     MSCAN12 TRANSMIT ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN1TXERR    _IO_AT(0x18F); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN1IDAR0    _IO_AT(0x190); 
 volatile  unsigned char  CAN1IDAR1    _IO_AT(0x191); 
 volatile  unsigned char  CAN1IDAR2    _IO_AT(0x192); 
 volatile  unsigned char  CAN1IDAR3    _IO_AT(0x193); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN1IDMR0    _IO_AT(0x194); 
 volatile  unsigned char  CAN1IDMR1    _IO_AT(0x195); 
 volatile  unsigned char  CAN1IDMR2    _IO_AT(0x196); 
 volatile  unsigned char  CAN1IDMR3    _IO_AT(0x197); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN1IDAR4    _IO_AT(0x198); 
 volatile  unsigned char  CAN1IDAR5    _IO_AT(0x199); 
 volatile  unsigned char  CAN1IDAR6    _IO_AT(0x19A); 
 volatile  unsigned char  CAN1IDAR7    _IO_AT(0x19B); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN1IDMR4    _IO_AT(0x19C); 
 volatile  unsigned char  CAN1IDMR5    _IO_AT(0x19D); 
 volatile  unsigned char  CAN1IDMR6    _IO_AT(0x19E); 
 volatile  unsigned char  CAN1IDMR7    _IO_AT(0x19F); 

/**************************************************************************************************/
/*                                  FOREGROUND RECEIVE BUFFER                                     */
/**************************************************************************************************/
 volatile  unsigned char  CAN1RXFG[16]    _IO_AT(0x1A0); 

/**************************************************************************************************/
/*                                  FOREGROUND TRANSMIT BUFFER                                    */
/**************************************************************************************************/
 volatile  unsigned char  CAN1TXFG[16]    _IO_AT(0x1B0); 

/*******************************************************************************************/
/*                             MSCAN12 MODULE CONTROL REGISTER 0                           */                                
/*******************************************************************************************/
 volatile  CANCTL0_TYPE CAN2CTL01 _IO_AT(0x1C0);               
...
/*                             MSCAN12 MODULE CONTROL REGISTER 1                           */
/*******************************************************************************************/
 volatile  CANCTL1_TYPE CAN2CTL11 _IO_AT(0x1C1);               
...
/*                               MSCAN12 BUS TIMING REGISTER 0                             */
/*******************************************************************************************/
 volatile  CANBTR0_TYPE CAN2BTR01 _IO_AT(0x1C2);               
...
/*                               MSCAN12 BUS TIMING REGISTER 1                             */
/*******************************************************************************************/
 volatile  CANBTR1_TYPE CAN2BTR11 _IO_AT(0x1C3);               
...
/*                               MSCAN12 RECEIVER FLAG REGISTER                            */
/*******************************************************************************************/
 volatile  CANRFLG_TYPE CAN2RFLG1 _IO_AT(0x1C4);               
...
/*                      MSCAN12 RECEIVER INTERRUPT ENABLE REGISTER                         */
/*******************************************************************************************/
 volatile  CANRIER_TYPE CAN2RIER1 _IO_AT(0x1C5);               
...
/*                          MSCAN12 TRANSMITTER FLAG REGISTER                              */
/*******************************************************************************************/
 volatile  CANTFLG_TYPE CAN2TFLG1 _IO_AT(0x1C6);               
...
/*                          MSCAN12 TRANSMITTER CONTROL REGISTER                           */
/*******************************************************************************************/
 volatile  CANTIER_TYPE CAN2TIER1 _IO_AT(0x1C7);               
...
/*                          MSCAN12 IDENTIFIER ACCEPTANCE CONTROL REGISTER                 */
/*******************************************************************************************/
 volatile  CANTARQ_TYPE CAN2TARQ1 _IO_AT(0x1C8);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTAAK_TYPE CAN2TAAK1 _IO_AT(0x1C9);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTBSEL_TYPE CAN2TBSEL1 _IO_AT(0x1CA);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANIDAC_TYPE CAN2IDAC1 _IO_AT(0x1CB);               
...
/*                                      MSCAN12 RECEIVE ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN2RXERR    _IO_AT(0x1CE); 

/**************************************************************************************************/
/*                                     MSCAN12 TRANSMIT ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN2TXERR    _IO_AT(0x1CF); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN2IDAR0    _IO_AT(0x1D0); 
 volatile  unsigned char  CAN2IDAR1    _IO_AT(0x1D1); 
 volatile  unsigned char  CAN2IDAR2    _IO_AT(0x1D2); 
 volatile  unsigned char  CAN2IDAR3    _IO_AT(0x1D3); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN2IDMR0    _IO_AT(0x1D4); 
 volatile  unsigned char  CAN2IDMR1    _IO_AT(0x1D5); 
 volatile  unsigned char  CAN2IDMR2    _IO_AT(0x1D6); 
 volatile  unsigned char  CAN2IDMR3    _IO_AT(0x1D7); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN2IDAR4    _IO_AT(0x1D8); 
 volatile  unsigned char  CAN2IDAR5    _IO_AT(0x1D9); 
 volatile  unsigned char  CAN2IDAR6    _IO_AT(0x1DA); 
 volatile  unsigned char  CAN2IDAR7    _IO_AT(0x1DB); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN2IDMR4    _IO_AT(0x1DC); 
 volatile  unsigned char  CAN2IDMR5    _IO_AT(0x1DD); 
 volatile  unsigned char  CAN2IDMR6    _IO_AT(0x1DE); 
 volatile  unsigned char  CAN2IDMR7    _IO_AT(0x1DF); 

/**************************************************************************************************/
/*                                  FOREGROUND RECEIVE BUFFER                                     */
/**************************************************************************************************/
 volatile  unsigned char  CAN2RXFG[16]    _IO_AT(0x1E0); 

/**************************************************************************************************/
/*                                  FOREGROUND TRANSMIT BUFFER                                    */
/**************************************************************************************************/
 volatile  unsigned char  CAN2TXFG[16]    _IO_AT(0x1F0); 

/*******************************************************************************************/
/*                             MSCAN12 MODULE CONTROL REGISTER 0                           */                                
/*******************************************************************************************/
 volatile  CANCTL0_TYPE CAN3CTL01 _IO_AT(0x200);               
...
/*                             MSCAN12 MODULE CONTROL REGISTER 1                           */
/*******************************************************************************************/
 volatile  CANCTL1_TYPE CAN3CTL11 _IO_AT(0x201);               
...
/*                               MSCAN12 BUS TIMING REGISTER 0                             */
/*******************************************************************************************/
 volatile  CANBTR0_TYPE CAN3BTR01 _IO_AT(0x202);               
...
/*                               MSCAN12 BUS TIMING REGISTER 1                             */
/*******************************************************************************************/
 volatile  CANBTR1_TYPE CAN3BTR11 _IO_AT(0x203);               
...
/*                               MSCAN12 RECEIVER FLAG REGISTER                            */
/*******************************************************************************************/
 volatile  CANRFLG_TYPE CAN3RFLG1 _IO_AT(0x204);               
...
/*                      MSCAN12 RECEIVER INTERRUPT ENABLE REGISTER                         */
/*******************************************************************************************/
 volatile  CANRIER_TYPE CAN3RIER1 _IO_AT(0x205);               
...
/*                          MSCAN12 TRANSMITTER FLAG REGISTER                              */
/*******************************************************************************************/
 volatile  CANTFLG_TYPE CAN3TFLG1 _IO_AT(0x206);               
...
/*                          MSCAN12 TRANSMITTER CONTROL REGISTER                           */
/*******************************************************************************************/
 volatile  CANTIER_TYPE CAN3TIER1 _IO_AT(0x207);               
...
/*                          MSCAN12 IDENTIFIER ACCEPTANCE CONTROL REGISTER                 */
/*******************************************************************************************/
 volatile  CANTARQ_TYPE CAN3TARQ1 _IO_AT(0x208);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTAAK_TYPE CAN3TAAK1 _IO_AT(0x209);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTBSEL_TYPE CAN3TBSEL1 _IO_AT(0x20A);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANIDAC_TYPE CAN3IDAC1 _IO_AT(0x20B);               
...
/*                                      MSCAN12 RECEIVE ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN3RXERR    _IO_AT(0x20E); 

/**************************************************************************************************/
/*                                     MSCAN12 TRANSMIT ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN3TXERR    _IO_AT(0x20F); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN3IDAR0    _IO_AT(0x210); 
 volatile  unsigned char  CAN3IDAR1    _IO_AT(0x211); 
 volatile  unsigned char  CAN3IDAR2    _IO_AT(0x212); 
 volatile  unsigned char  CAN3IDAR3    _IO_AT(0x213); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN3IDMR0    _IO_AT(0x214); 
 volatile  unsigned char  CAN3IDMR1    _IO_AT(0x215); 
 volatile  unsigned char  CAN3IDMR2    _IO_AT(0x216); 
 volatile  unsigned char  CAN3IDMR3    _IO_AT(0x217); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (Second bank)                       */
/**************************************************************************************************/

 volatile  unsigned char  CAN3IDAR4    _IO_AT(0x218); 
 volatile  unsigned char  CAN3IDAR5    _IO_AT(0x219); 
 volatile  unsigned char  CAN3IDAR6    _IO_AT(0x21A); 
 volatile  unsigned char  CAN3IDAR7    _IO_AT(0x21B); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN3IDMR4    _IO_AT(0x21C); 
 volatile  unsigned char  CAN3IDMR5    _IO_AT(0x21D); 
 volatile  unsigned char  CAN3IDMR6    _IO_AT(0x21E); 
 volatile  unsigned char  CAN3IDMR7    _IO_AT(0x21F); 

/**************************************************************************************************/
/*                                  FOREGROUND RECEIVE BUFFER                                     */
/**************************************************************************************************/
 volatile  unsigned char  CAN3RXFG[16]    _IO_AT(0x220); 

/**************************************************************************************************/
/*                                  FOREGROUND TRANSMIT BUFFER                                    */
/**************************************************************************************************/
 volatile  unsigned char  CAN3TXFG[16]    _IO_AT(0x230); 

/*******************************************************************************************/
/*                             MSCAN12 MODULE CONTROL REGISTER 0                           */                                
/*******************************************************************************************/
 volatile  CANCTL0_TYPE CAN4CTL01 _IO_AT(0x280);               
...
/*                             MSCAN12 MODULE CONTROL REGISTER 1                           */
/*******************************************************************************************/
 volatile  CANCTL1_TYPE CAN4CTL11 _IO_AT(0x281);               
...
/*                               MSCAN12 BUS TIMING REGISTER 0                             */
/*******************************************************************************************/
 volatile  CANBTR0_TYPE CAN4BTR01 _IO_AT(0x282);               
...
/*                               MSCAN12 BUS TIMING REGISTER 1                             */
/*******************************************************************************************/
 volatile  CANBTR1_TYPE CAN4BTR11 _IO_AT(0x283);               
...
/*                               MSCAN12 RECEIVER FLAG REGISTER                            */
/*******************************************************************************************/
 volatile  CANRFLG_TYPE CAN4RFLG1 _IO_AT(0x284);               
...
/*                      MSCAN12 RECEIVER INTERRUPT ENABLE REGISTER                         */
/*******************************************************************************************/
 volatile  CANRIER_TYPE CAN4RIER1 _IO_AT(0x285);               
...
/*                          MSCAN12 TRANSMITTER FLAG REGISTER                              */
/*******************************************************************************************/
 volatile  CANTFLG_TYPE CAN4TFLG1 _IO_AT(0x286);               
...
/*                          MSCAN12 TRANSMITTER CONTROL REGISTER                           */
/*******************************************************************************************/
 volatile  CANTIER_TYPE CAN4TIER1 _IO_AT(0x287);               
...
/*                          MSCAN12 IDENTIFIER ACCEPTANCE CONTROL REGISTER                 */
/*******************************************************************************************/
 volatile  CANTARQ_TYPE CAN4TARQ1 _IO_AT(0x288);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTAAK_TYPE CAN4TAAK1 _IO_AT(0x289);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANTBSEL_TYPE CAN4TBSEL1 _IO_AT(0x28A);               
...
/*                                           */
/*******************************************************************************************/
 volatile  CANIDAC_TYPE CAN4IDAC1 _IO_AT(0x28B);               
...
/*                                      MSCAN12 RECEIVE ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN4RXERR    _IO_AT(0x28E); 

/**************************************************************************************************/
/*                                     MSCAN12 TRANSMIT ERROR COUNTER                             */
/**************************************************************************************************/
 volatile  unsigned char  CAN4TXERR    _IO_AT(0x28F); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN4IDAR0    _IO_AT(0x290); 
 volatile  unsigned char  CAN4IDAR1    _IO_AT(0x291); 
 volatile  unsigned char  CAN4IDAR2    _IO_AT(0x292); 
 volatile  unsigned char  CAN4IDAR3    _IO_AT(0x293); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (First bank)                        */
/**************************************************************************************************/
 volatile  unsigned char  CAN4IDMR0    _IO_AT(0x294); 
 volatile  unsigned char  CAN4IDMR1    _IO_AT(0x295); 
 volatile  unsigned char  CAN4IDMR2    _IO_AT(0x296); 
 volatile  unsigned char  CAN4IDMR3    _IO_AT(0x297); 

/**************************************************************************************************/
/*                            IDENTIFIER ACCEPTANCE REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN4IDAR4    _IO_AT(0x298); 
 volatile  unsigned char  CAN4IDAR5    _IO_AT(0x299); 
 volatile  unsigned char  CAN4IDAR6    _IO_AT(0x29A); 
 volatile  unsigned char  CAN4IDAR7    _IO_AT(0x29B); 

/**************************************************************************************************/
/*                                  IDENTIFIER MASK REGISTERS (Second bank)                       */
/**************************************************************************************************/
 volatile  unsigned char  CAN4IDMR4    _IO_AT(0x29C); 
 volatile  unsigned char  CAN4IDMR5    _IO_AT(0x29D); 
 volatile  unsigned char  CAN4IDMR6    _IO_AT(0x29E); 
 volatile  unsigned char  CAN4IDMR7    _IO_AT(0x29F); 

/**************************************************************************************************/
/*                                  FOREGROUND RECEIVE BUFFER                                     */
/**************************************************************************************************/
 volatile  unsigned char  CAN4RXFG[16]    _IO_AT(0x2A0); 

/**************************************************************************************************/
/*                                  FOREGROUND TRANSMIT BUFFER                                    */
/**************************************************************************************************/
 volatile  unsigned char  CAN4TXFG[16]    _IO_AT(0x2B0); 

/*******************************************************************************************/
/*                                           PORT T                                        */
/*******************************************************************************************/
 volatile  unsigned char PTT     _IO_AT(0x240);  
 volatile  unsigned char PTIT    _IO_AT(0x241);  
 volatile  unsigned char DDRT    _IO_AT(0x242);  
 volatile  unsigned char RDRT    _IO_AT(0x243);  
 volatile  unsigned char PERT    _IO_AT(0x244);  
 volatile  unsigned char PPST    _IO_AT(0x245);  

/*******************************************************************************************/
/*                                           PORT S                                        */
/*******************************************************************************************/
 volatile  unsigned char PTS     _IO_AT(0x248);  
 volatile  unsigned char PTIS    _IO_AT(0x249);  
 volatile  unsigned char DDRS    _IO_AT(0x24A);  
 volatile  unsigned char RDRS    _IO_AT(0x24B);  
 volatile  unsigned char PERS    _IO_AT(0x24C);  
 volatile  unsigned char PPSS    _IO_AT(0x24D);  
 volatile  unsigned char WOMS    _IO_AT(0x24E);  

/*******************************************************************************************/
/*                                           PORT M                                        */
/*******************************************************************************************/
 volatile  unsigned char PTM     _IO_AT(0x250);  
 volatile  unsigned char PTIM    _IO_AT(0x251);  
 volatile  unsigned char DDRM    _IO_AT(0x252);  
 volatile  unsigned char RDRM    _IO_AT(0x253);  
 volatile  unsigned char PERM    _IO_AT(0x254);  
 volatile  unsigned char PPSM    _IO_AT(0x255);  
 volatile  unsigned char WOMM    _IO_AT(0x256);  

/*******************************************************************************************/
/*                                           PORT P                                        */
/*******************************************************************************************/
 volatile  unsigned char PTP     _IO_AT(0x258);  
 volatile  unsigned char PTIP    _IO_AT(0x259);  
 volatile  unsigned char DDRP    _IO_AT(0x25A);  
 volatile  unsigned char RDRP    _IO_AT(0x25B);  
 volatile  unsigned char PERP    _IO_AT(0x25C);  
 volatile  unsigned char PPSP    _IO_AT(0x25D);  
 volatile  unsigned char PIEP    _IO_AT(0x25E);  
 volatile  unsigned char PIFP    _IO_AT(0x25F);  

/*******************************************************************************************/
/*                                           PORT H                                        */
/*******************************************************************************************/
 volatile  unsigned char PTH     _IO_AT(0x260);  
 volatile  unsigned char PTIH    _IO_AT(0x261);  
 volatile  unsigned char DDRH    _IO_AT(0x262);  
 volatile  unsigned char RDRH    _IO_AT(0x263);  
 volatile  unsigned char PERH    _IO_AT(0x264);  
 volatile  unsigned char PPSH    _IO_AT(0x265);  
 volatile  unsigned char PIEH    _IO_AT(0x266);  
 volatile  unsigned char PIFH    _IO_AT(0x267);  

/*******************************************************************************************/
/*                                           PORT J                                        */
/*******************************************************************************************/
 volatile  unsigned char PTJ     _IO_AT(0x268);  
 volatile  unsigned char PTIJ    _IO_AT(0x269);  
 volatile  unsigned char DDRJ    _IO_AT(0x26A);  
 volatile  unsigned char RDRJ    _IO_AT(0x26B);  
 volatile  unsigned char PERJ    _IO_AT(0x26C);  
 volatile  unsigned char PPSJ    _IO_AT(0x26D);  
 volatile  unsigned char PIEJ    _IO_AT(0x26E);  
 volatile  unsigned char PIFJ    _IO_AT(0x26F);  
